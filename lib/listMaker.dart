...
class _ListMakerState extends State<ListMaker> {
  ...
  void get() async{
    ...
    typedzekr=await Data().getZekrData(azkarDb, zekr);
    typedzekrinfo=await Data().getZekrInfoData(azkarDb, zekr);
    typedzekrcount=await Data().getZekrCount(azkarDb, zekr);
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: InkWell(
                  onTap: () async {
                    pushPage(context,
                        Azkar(azkar: typedzekr,
                            azkarinfo: typedzekr=await Data().getZekrData(azkarDb, categories[index])
